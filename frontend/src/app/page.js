...
function trgrMobNav(){
  ...
  return(
    <div className="mainWrapper bg-gradient-to-r from-[#141E30] to-black ">
          ...
          <motion.section className="h-screen flex flex-col justify-evenly gap-10 pages " initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.8 }}  viewport={{ once:true }} 
 id="pageOne">
          ...
          <motion.section className="pages grid min-[780px]:grid-cols-[1fr_2fr] min-[780px]:grid-row-auto grid-col-1 grid-row-[1fr_2fr] min-[780px]:gap-0 gap-10 box-border px-5 pt-10 pb-30" initial={{ opacity: 0, y: 100 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once:true }} 
 id="pageTwo">
...
> 
 ...
 id="pageThree">
          ...
          <motion.section className="pages h-fit flex flex-col items-center"  initial={{ opacity: 0, y: 100 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{once:true}} 
id="pageFour">
